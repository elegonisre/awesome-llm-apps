...
> **Note:** The `cd` path in the original README was incorrect (`ai_agent_tutorials/ai_chess_game`). The correct path reflects the actual directory structure in the repo.
